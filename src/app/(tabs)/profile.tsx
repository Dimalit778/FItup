...
// import { subscriptionService } from "../../../temp/services/subscriptionService";
// import { useUserProfileStore } from "../../store/userProfileStore";
// import type { ActivityLevel, Gender, UserGoal, UserProfile } from "../../types/user";
...
//             <Text style={styles.avatarText}>{user?.primaryEmailAddress?.emailAddress?.[0].toUpperCase() || "?"}</Text>
//           </View>
...
//           </View>
//           {localProfile.subscriptionStatus !== "premium" && (
//             <TouchableOpacity style={styles.upgradeButton} onPress={handleSubscribe} disabled={loading}>
//               {loading ? <ActivityIndicator color="#FFFFFF" /> : <Text style={styles.upgradeButtonText}>Upgrade</Text>}
//             </TouchableOpacity>
//           )}
//         </View>
//       </View>
